            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 3;
                  return modelObject.model.findOne(sanitizeArgs(args)).populate("sections topics");
                ...
                case 6:
                  _context.t0 = (0, _graphqlServerExpress.formatError)(errorObj({ _error: "Permission denied" }));
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 3;
                  return modelObject.model.find(sanitizeArgs(args)).populate("sections topics");
                ...
                case 6:
                  _context2.t0 = (0, _graphqlServerExpress.formatError)(errorObj({ _error: "Permission denied" }));
          ...
          return _regenerator2.default.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 8:
                  _context3.t0 = (0, _graphqlServerExpress.formatError)(errorObj({ _error: "Permission denied" }));
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  _context4.next = 4;
                  return modelObject.model.findOneAndUpdate({ _id: id }, args, {
                    new: true
                  });
                ...
                case 7:
                  _context4.t0 = (0, _graphqlServerExpress.formatError)(errorObj({ _error: "Permission denied" }));
          ...
          return _regenerator2.default.wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                ...
                case 6:
                  _context5.t0 = (0, _graphqlServerExpress.formatError)(errorObj({ _error: "Permission denied" }));
